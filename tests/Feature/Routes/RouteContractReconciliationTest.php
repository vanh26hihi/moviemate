...
final class RouteContractReconciliationTest extends TestCase
{
    ...
    public function test_core_named_route_contracts_exist(): void
    {
        foreach ([
            ...
            'tickets.verify', 'user.movies.index', 'user.movies.show', 'foods.index',
            ...
            'user.profile', 'user.reviews.index', 'user.loyalty.history',
            ...
            'payments.resume',
            'staff.dashboard', 'staff.tickets.index', 'staff.tickets.check',
            'staff.tickets.consume', 'staff.counter.index', 'staff.sales.index',
            'staff.prints.index', 'staff.checkins.index',
            'admin.dashboard', 'admin.reports.index', 'admin.movies.index',
            'admin.genres.index', 'admin.reviews.index', 'admin.loyalty-settings.edit',
            'admin.loyalty.index', 'admin.cinemas.index', 'admin.rooms.index',
            'admin.room-types.index', 'admin.layout-templates.index',
            'admin.showtimes.index', 'admin.pricing-rules.index', 'admin.bookings.index',
            'admin.payments.index', 'admin.discounts.index', 'admin.ticket-checkins.index',
