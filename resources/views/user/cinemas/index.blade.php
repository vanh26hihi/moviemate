...
<section class="cinema-surface py-10 md:py-14">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-4 flex flex-wrap items-center gap-3">
            <button id="nearbyCinemaBtn" type="button" class="btn-secondary" data-nearby-list="cinemaDiscoveryList"><i class="ph-fill ph-navigation-arrow" aria-hidden="true"></i>Rạp gần bạn</button>
...
<section class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
    <div id="cinemaDiscoveryList" class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        @forelse($cinemas as $cinema)
            <article class="cinema-card flex flex-col rounded-3xl p-6" data-cinema-card data-latitude="{{ $cinema->latitude }}" data-longitude="{{ $cinema->longitude }}">
                ...
                <p class="mt-4 hidden text-sm font-extrabold text-brand-start" data-cinema-distance></p>
        ...
        @empty
            <div class="cinema-card col-span-full rounded-3xl p-10 text-center"><h2 class="text-xl font-extrabold app-text">Không tìm thấy rạp phù hợp.</h2></div>
        @endforelse
    </div>
</section>
@endsection
