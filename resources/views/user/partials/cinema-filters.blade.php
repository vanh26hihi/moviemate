{{-- Merge repair: the incoming branch left a stray unterminated "<?php" on line 1, which
     Blade would emit as literal text (or fatal) if this partial is ever included. The
     markup is preserved verbatim; only the invalid opening tag is removed. This partial is
     currently not referenced by any view. --}}
