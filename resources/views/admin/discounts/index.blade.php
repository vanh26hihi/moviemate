...
@section('content')
<div class="admin-page-header"><div><h1 class="admin-page-title sr-only sm:not-sr-only">Khuyến mãi</h1><p class="admin-page-subtitle">Khuyến mãi cấp đơn đặt vé, tách biệt hoàn toàn với bảng giá vé. Mỗi đơn đặt vé áp dụng tối đa một mã khuyến mãi.</p></div>@can('discounts.manage')<a class="admin-btn-primary" href="{{ route('admin.discounts.create') }}">Thêm khuyến mãi</a>@endcan</div>
