...
@section('title', 'Quáº£n lÃ½ vÃ© Ä‘áº·t - MovieMate')
@section('page-title', 'Quáº£n lÃ½ vÃ© Ä‘áº·t')
...
<div class="rounded-[28px] border border-white/10 bg-[#151A27] p-6">
    <div class="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
            <h1 class="text-3xl font-black">Quáº£n lÃ½ vÃ© Ä‘áº·t</h1>
            <p class="mt-2 text-gray-400">Danh sÃ¡ch vÃ© Ä‘Ã£ Ä‘áº·t</p>
        </div>
