                            ...
                            <td>
                                <div class="flex flex-wrap items-center justify-end gap-2">
                                    ...
                                    @can('showtimes.update')
                                        ...
                                        <a href="{{ route('admin.showtimes.edit', $showtime) }}" data-showtime-edit-action class="inline-flex items-center justify-center w-9 h-9 rounded-xl border app-border app-muted hover:text-brand-start hover:border-brand-start transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-start" title="Chỉnh sửa suất chiếu" aria-label="Chỉnh sửa suất chiếu {{ $showtime->movie->title }} lúc {{ $window?->start->format('H:i d/m/Y') }}"><i class="ph-bold ph-pencil-simple text-xs" aria-hidden="true"></i></a>
