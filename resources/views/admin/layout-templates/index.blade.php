...
<div class="space-y-6">
    ...
    <div class="app-card overflow-hidden"><div class="overflow-x-auto"><table class="min-w-[760px] w-full text-sm"><thead><tr class="border-b app-border text-left"><th class="p-4">Mẫu</th><th>Loại phòng</th><th>Lưới logic</th><th>Vị trí ghế / lần áp dụng</th><th>Trạng thái</th><th></th></tr></thead><tbody>
