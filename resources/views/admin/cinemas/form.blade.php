...
<form method="POST" action="{{ $editing ? route('admin.cinemas.update', $cinema) : route('admin.cinemas.store') }}" class="admin-form-card max-w-4xl">
    ...
    <div class="grid gap-5 md:grid-cols-2">
        @foreach([['code','Mã chi nhánh','CG'],['name','Tên chi nhánh','MovieMate Cầu Giấy'],['address','Địa chỉ','Số nhà, đường, quận/huyện'],['city','Tỉnh / thành phố','Hà Nội'],['country','Quốc gia','Việt Nam'],['phone','Điện thoại','']] as [$field,$label,$placeholder])
