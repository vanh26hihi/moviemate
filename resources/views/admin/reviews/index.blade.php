...
@section('title', 'Quáº£n lÃ½ Ä‘Ã¡nh giÃ¡ - MovieMate')
...
<div class="rounded-[28px] border border-white/10 bg-[#151A27] p-6">
    <div class="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
            <h1 class="text-3xl font-black">Quáº£n lÃ½ Ä‘Ã¡nh giÃ¡</h1>
            <p class="mt-2 text-gray-400">ÄÃ¡nh giÃ¡ cá»§a khÃ¡ch hÃ ng</p>
        </div>
