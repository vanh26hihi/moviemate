...
@section('title', 'Quáº£n lÃ½ ngÆ°á»i dÃ¹ng - MovieMate')
@section('page-title', 'Quáº£n lÃ½ ngÆ°á»i dÃ¹ng')
...
<div class="rounded-[28px] border border-white/10 bg-[#151A27] p-6">
    <div class="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
        <div>
            <h1 class="text-3xl font-black">Quáº£n lÃ½ ngÆ°á»i dÃ¹ng</h1>
            <p class="mt-2 text-gray-400">Danh sÃ¡ch tÃ i khoáº£n</p>
        </div>

        <a href="#" class="rounded-2xl bg-gradient-to-r from-[#FF3D57] to-[#FF7A18] px-5 py-3 text-sm font-bold">
            ThÃªm ngÆ°á»i dÃ¹ng
        </a>
    </div>
