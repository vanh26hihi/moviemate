...
<body class="app-page font-sans antialiased flex h-screen overflow-hidden">
    <a href="#staff-main-content" class="sr-only focus:not-sr-only fixed left-4 top-4 z-[100] rounded-xl bg-brand-start px-4 py-3 font-bold text-white shadow-xl focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-brand-start">Bỏ qua điều hướng, đến nội dung chính</a>
    ...
    <main id="staff-main-content" class="staff-shell flex-grow flex flex-col min-w-0 app-bg relative h-full overflow-hidden" tabindex="-1">
