...
final class BookingLookupCapability
{
    private const VERSION = 'b1';
    ...
    private function key(): string
    {
        ...
        if (! is_string($configured) || $configured === '') {
            throw new BookingTokenConfigurationException('APP_KEY must be configured before booking lookup capabilities can be used.');
        }
        ...
        return hash_hmac('sha256', 'moviemate/booking-lookup/v1', $key, true);
    }
}
